...
export const zhCN: MessageCatalog = {
  ...
  "live control": "在线控制",
  Nodes: "节点",
  "Filter, group, and batch-operate on subscription nodes": "对订阅节点做筛选、分组和批量操作",
  "Audit the current subscription snapshot by node, switch grouping modes, and launch bulk actions without leaving the table deck.":
    "按节点审视当前订阅快照，切换分组视图，并且不离开表格就能发起批量动作。",
  "Node filters": "节点筛选",
  Reset: "重置",
  Search: "搜索",
  "proxy name, server, IP, region": "节点名、服务器、IP、地区",
  "Proxy types": "节点类型",
  Regions: "地区",
  "Probe state": "探测状态",
  "Session state": "会话状态",
  ...
  "Sort by": "排序字段",
  Order: "排序方向",
  "All probe states": "全部探测状态",
  Unreachable: "不可达",
  Unprobed: "未探测",
  "All session states": "全部会话状态",
  "With sessions": "有会话",
  "Without sessions": "无会话",
  "Any family": "任意协议族",
  "Has IPv4": "含 IPv4",
  "Has IPv6": "含 IPv6",
  "Dual stack": "双栈",
  ...
  "Filters, sorting, and pagination come from the backend; the current page can then be regrouped locally by IP, region, or subscription source.":
    "筛选、排序和分页都由后端执行；当前页结果再由前端按 IP、地区或订阅源重新分组。",
  refreshing: "刷新中",
  "snapshot ready": "快照就绪",
  syncing: "同步中",
  stable: "稳定",
  ...
  "By subscription": "按订阅",
  "Selected nodes": "选中节点",
  "All filtered nodes": "全部筛选结果",
  "Clear selection": "清空选择",
  Export: "导出",
  "Export format": "导出格式",
  "Exporting...": "导出中...",
  "Export CSV": "导出 CSV",
  "Node links (.txt, one per line)": "节点链接（.txt，每行一个）",
  "CSV metadata (.csv)": "CSV 元数据（.csv）",
  "Creating sessions...": "创建会话中...",
  ...
  "Adjust the filters or load a subscription to populate this workspace.":
    "调整筛选条件，或者先加载订阅来填充这个工作台。",
  Node: "节点",
  IPs: "IP",
  "No preferred IP": "没有首选 IP",
  "v4: {value}": "v4: {value}",
  "v6: {value}": "v6: {value}",
  "Rows per page": "每页行数",
  Previous: "上一页",
  Next: "下一页",
  "Nodes request failed": "节点请求失败",
  "Exported node inventory as CSV": "已导出节点库存 CSV",
  "Exported node links as TXT": "已导出节点链接 TXT",
  "Created {opened} sessions with {failed} failures":
    "已创建 {opened} 个会话，另有 {failed} 个失败",
  "Created {count} sessions": "已创建 {count} 个会话",
  "Nothing on this route yet": "这个路由还没有内容",
  "The control surface only exposes Overview, Tasks, Nodes, and Sessions right now.":
    "当前控制台只开放了总览、任务、节点和会话这几个路由。",
