...
export const zhCN: MessageCatalog = {
  ...
  "Probe failed": "探测失败",
  "Probe current group": "测速当前分组",
  "Probe all visible nodes in this group": "测速当前分组内全部可见节点",
  "A visible node in this group is already queued or running a probe":
    "当前分组已有可见节点正在排队或测速",
  "Probe this node": "测速此节点",
  "Probe this current node": "测速当前节点",
  "This node is already queued or running a probe": "此节点已在排队或测速",
  "Probe current node {name}": "测速当前节点 {name}",
  "Probe node {name}": "测速节点 {name}",
  ...
  "Probe running": "测速运行中",
  "-- ms": "-- ms",
  "Automatic latency probe": "自动延迟测速",
  "Loading system settings...": "正在加载系统设置……",
  "All subscription nodes are probed every {minutes} minutes.":
    "所有订阅节点每 {minutes} 分钟自动测速一次。",
  "Interval minutes": "间隔分钟数",
  "Saving...": "保存中……",
  Save: "保存",
  "Automatic latency probe interval saved: {minutes} minutes": "自动测速间隔已保存：{minutes} 分钟",
  "Queued metadata refresh": "已加入元信息刷新队列",
  "Queued latency probe": "已加入测速队列",
  "Queued subscription update": "已加入订阅更新队列",
  ...
  "Update selected subscriptions": "更新",
  "Sync subscription": "更新订阅",
  "Sync selected subscriptions": "更新所选订阅",
  "Updating...": "更新中……",
  "Updating subscriptions...": "订阅更新中……",
  "Deleting...": "删除中……",
  "Updated allocation for {importId}": "已更新导入 {importId} 的分配",
  "Updated subscription import {importId}": "已更新订阅导入 {importId}",
  "Updated {count} subscription imports": "已更新 {count} 个订阅导入",
  ...
  "Search IP, node, subscription, or city": "搜索 IP、节点、订阅或城市",
  City: "城市",
  "Loading IP options...": "正在加载 IP 选项……",
  "Could not load IP options": "无法加载 IP 选项",
  "Select IP {ip}": "选择 IP {ip}",
  nodes: "个节点",
  "Unknown location": "未知地区",
  "Unknown subscription": "未知订阅",
  "Select an IP": "选择一个 IP",
  "{count} candidate nodes selected": "已选择 {count} 个候选节点",
  "Pick an IP on the left to review candidate nodes.": "在左侧选择 IP 后查看候选节点。",
  "Select node {node}": "选择节点 {node}",
  Candidate: "候选",
  Excellent: "优秀",
  Good: "良好",
  Fair: "一般",
  Poor: "较差",
  "Last probe failed": "上次测速失败",
  "Median latency {latency}": "中位延迟 {latency}",
  "Median latency {latency}. Quality: {quality}": "中位延迟 {latency}。质量：{quality}",
  "Latency quality: {quality}": "延迟质量：{quality}",
  "Select all nodes": "全选节点",
  "Clear nodes": "清空节点",
  "{count} IPs selected": "已选择 {count} 个 IP",
  "Pick an IP and candidate nodes for {sessionId}. The listener stays unchanged.":
    "为 {sessionId} 选择 IP 和候选节点，监听地址保持不变。",
  "Use selected candidates": "使用所选候选",
};
