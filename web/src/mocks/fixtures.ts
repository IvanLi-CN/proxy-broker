...
export const sessionIpNodeOptionsFixture: SearchSessionIpNodeOptionsResponse = {
  groups: [
    {
      key: "browser-core",
      label: "browser-core",
      items: [
        {
          ip: "203.0.113.10",
          group_key: "browser-core",
          group_label: "browser-core",
          subscription_name: "browser-core",
          country_code: "JP",
          country_name: "Japan",
          region_name: "Tokyo",
          city: "Chiyoda",
          ...
          nodes: [
            ...
            },
            {
              ...
              city: "Chiyoda",
              last_probe_ok: true,
              median_latency_ms: 96,
              recent_probe_samples: createProbeSamples(
                "node-jp-tokyo-backup",
                "203.0.113.10",
                [96, 101, 117],
              ),
    ...
    },
    {
      ...
      items: [
        {
          ip: "198.51.100.42",
          group_key: "fallback-lab",
          group_label: "fallback-lab",
          subscription_name: "fallback-lab",
          country_code: "US",
          country_name: "United States",
          region_name: "California",
          city: "San Jose",
